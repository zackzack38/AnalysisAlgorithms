...
int main()
{
    ...
    /*
    while(to_string(curX)+to_string(curY)+to_string(curZ) != to_string(ex)+to_string(ey)+to_string(ez))
    {
        if(map[to_string(curX)+to_string(curY)+to_string(curZ)].visited == 0) // v is not labeled as discoverd
        {
            map[to_string(curX)+to_string(curY)+to_string(curZ)].visited = 1;
            if(v.dirN == 1)
            {
                //curY = curY - 1;
                if(map[to_string(curX)+to_string(curY-1)+to_string(curZ)].visited == 0)
                {
                    curY = curY - 1;
                    S.push(map[to_string(curX)+to_string(curY)+to_string(curZ)]);
                    cout << "N ";
                    //output.push("N");
            ...
            {
                //curZ = curZ + 1;
                if(map[to_string(curX)+to_string(curY)+to_string(curZ+1)].visited == 0)
                {
                    curZ = curZ + 1;
                    S.push(map[to_string(curX)+to_string(curY)+to_string(curZ)]);
                    cout << "E ";
            ...
            {
                //curX = curX + 1;
                if(map[to_string(curX+1)+to_string(curY)+to_string(curZ)].visited == 0)
                {
                    curX = curX + 1;
                    S.push(map[to_string(curX)+to_string(curY)+to_string(curZ)]);
                    cout << "U ";
